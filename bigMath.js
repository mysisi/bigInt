...
(function (root,undefined){
    ...
    var BigInt = (function () {
        ...
        BigInt.prototype = {
            add: function(y){
                return bigint_add(this,y);
            },
            sub: function(y){
                return bigint_sub(this,y);
            },
            mul: function(y){
                return bigint_mul(this,y);
            },
            div: function(y){
                return bigint_div(this,y);
            },
            mod: function(y){
                return bigint_mod(this,y);
            },
            cmp: function(y){
                return bigint_cmp(this,y);
            }
        };
    ...
    function bigAdd(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        var result = bigArg1.add(bigArg2);
        return result.toString();
    }

    //减法
    function bigSub(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        var result = bigArg1.sub(bigArg2);
        return result.toString();
    }

    //乘法
    function bigMul(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        var result = bigArg1.mul(bigArg2);
        return result.toString();
    }

    //除法
    function bigDiv(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        var result = bigArg1.div(bigArg2);
        return result.toString();
    }

    //取余
    function bigMod(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        var result = bigArg1.mod(bigArg2);
        return result.toString();
    }

    //比较,arg1>arg2返回1，arg1<arg2返回-1，相等返回0
    function bigCmp(arg1,arg2){
        var bigArg1 = new BigInt(arg1);
        var bigArg2 = new BigInt(arg2);
        return bigArg1.cmp(bigArg2);
    }
    ...
    if (typeof exports !== 'undefined') {
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = bigMath;
        }
        ...
        bigMath.noConflict = (function(oldAccounting) {
            return function() {
                // Reset the value of the root's `accMath` variable:
                root.bigMath = oldAccounting;
                // Delete the noConflict method:
                bigMath.noConflict = undefined;
